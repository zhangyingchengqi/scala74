package com.yc.scala3.oop.part2_advanced.sort3

object Test1_ordering extends App {
  ...
  class Cmp3[T: Ordering](o1: T, o2: T)(implicit cmptor: Ordering[T]) { // implicit cmptor:Ordering[T]  这表明参数 cmptor 是一个 Ordering[T]的对象
    def bigger = if (cmptor.compare(o1, o2) > 0) o1 else o2 //  cmptor中定义了 compare方法
  }
